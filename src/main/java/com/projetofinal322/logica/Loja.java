...
public class Loja {
    ...
    // Inicializador estático para garantir que os dados e seus preços sejam
    // configurados ao carregar a classe
    static {
    ...
    /**
     * Realiza a ação da compra de um dado por um jogador j, ou a impede se
     * necessário.
     * 
    ...
    public static void promocaoRelampago(Jogador j) {
        ...
        System.out
                .println("Você deseja comprar algum dado? Se sim, digite o número do dado desejado; se não, digite 0.");
