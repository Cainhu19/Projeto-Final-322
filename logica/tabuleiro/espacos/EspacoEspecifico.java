...
/**
 * Classe de espaços específicos que ocorrem apenas uma vez (ou duas, se suas ações forem idênticas) no tabuleiro.
    ...
    public void acao(Jogador jogador) {
        switch(id) {
            ...
            case "ROLAR_DADO_DE_NOVO":
                // Espaços 50a e 64 (tempo com a família revigorou suas energias, role o dado de novo / motivação súbita, role o dado de novo)
            ...
            case "TENTAR_ROUBAR_P_OPORTUNIDADES":
                // Espaço 100b (tente copiar os passos de uma pessoa e se destacar mais que ela: se conseguir, ganhe 100 pontos de oportunidade da pessoa, se não, perca 100 pontos para ela (decidido em dado))
                ...
                if (resultadoDadoUm > resultadoDadoDois) {
                    ...
                    System.out.printf("%s copiou o que %s fazia e ganhou 100 pontos de oportunidades de %s!", jogador.getNome(), jogadorCopiado.getNome(), jogadorCopiado.getNome());
                    break;
                } else if (resultadoDadoUm < resultadoDadoDois) {
                    jogador.ajustarPontosOportunidade(-100);
                    jogadorCopiado.ajustarPontosOportunidade(100);
                    System.out.printf("%s passou vergonha tentando imitar %s e perdeu 100 pontos de oportunidades para %s!", jogador.getNome(), jogadorCopiado.getNome(), jogadorCopiado.getNome());
                    break;
                }
